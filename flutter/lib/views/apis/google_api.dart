...
import 'package:flutter_chapitre13/models/place_model.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

const GOOGLE_KEY_API = 'AIzaSyCjIpxYSosPTO-fynUIMcP7bIPw_dXsJbE';
...
Uri _queryPlaceDetailsBuilder(String placeId) {
  return Uri.parse(
      "https://maps.googleapis.com/maps/api/place/details/json?fields=formatted_address,geometry&place_id=$placeId&key=$GOOGLE_KEY_API");
}
